        ...
        <Jumbotron style={jumboStyle}>
            ...
            <Card>
                ...
                <Card.Body>
                    <Card border="light">
                        <Card.Body>
                            <a href='https://patentscope2.wipo.int/search/en/detail.jsf?docId=WO2018180239' target="_blank" rel="noopener noreferrer"> WO2018180239 </a> Information  Processing  Device  and  Method -  prediction  of  internal  greenhouse  environment  and minimization of sensor installation and maintenance cost using machine learning.
                        </Card.Body>
                    </Card>
                </Card.Body>
            </Card>
                    ...
                    <Card border="light">
                        <Card.Body>
                            ...
                            <p style={{marginTop:'0.5rem', marginLeft:'3rem'}}>
                                ...
                                [<a href='https://kris-singh.github.io/papers/graph2vec_icdm.pdf' target="_blank" rel="noopener noreferrer">preprint</a>]
                                <br/>
                                <i>Studied: </i>
